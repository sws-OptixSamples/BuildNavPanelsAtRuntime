# BuildNavPanelsAtRuntime

Example project showing how you can use NetLogic as a child node of a navigation panel to add new "tabs" or NavigationPanelItem to the navigation panel at runtime.  
This example will use a common screen with a data object alias for each tab.
